							...
							<div class="module-body">
								...
								<table class="table table-striped">
								  ...
								  <tbody>
									<tr>
										<?php 
											$sql = mysql_query("select a.imei, a.numero_tel, a.localizacao, a.usuario_cliente, a.hora_ocorrencia, p.nome as nome_produto from auditoria as a 
																inner join produto as p on a.id_produto=p.id");
	
											if(mysql_num_rows($sql)>0){
												while($linhas = mysql_fetch_array($sql, MYSQL_ASSOC)){
												echo "<td>".$linhas['imei']."</td>";
												echo "<td>".$linhas['numero_tel']."</td>";
												echo "<td> <a href=".$linhas['localizacao'].">Localização</a> </td>";
												echo "<td>".$linhas['usuario_cliente']."</td>";
												echo "<td>".$linhas['hora_ocorrencia']."</td>";
