...
if(!(empty($nome))){
	$sql = "insert into tipo (nome,data_cadastro) values ('$nome',now())";

	$resultado = mysql_query($sql);

	if($resultado){
		$Deu_Certo = true;
		$msg = "Cadastro de Tipo efetuado com sucesso";
	}else{
					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="module-body">
									...
									<form class="form-horizontal row-fluid"  method="post" action="novo_tipo.php">
										<div class="control-group">
											<label class="control-label" for="basicinput">Nome: </label>
											<div class="controls">
												<input type="text" id="basicinput" placeholder="Informe o nome do tipo" class="span8" name="nome" required>
